...
![Booting from Flash Drive](booting_from_flash_drive.png "Booting from flash drive")<figcaption>
...
![Screenshot of basic setup](screenshot_of_basic_setup_step_1.png "Screenshot of basic setup: Step 1")<figcaption>
